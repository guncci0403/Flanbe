...
<div class="sidebar">
	<div class="site-width">
		...
		<ul id="side-menu" class="sidebar-menu">
			<li class="dropdown">
			<a href="#" style="text-align: center; font-size: 15px;">계약서 작성</a></li>
		</ul>
	</div>
	<div class="site-width">
...
<%--   <form id="insertCon" action="${cp }/contract/insertContract" > --%>
<%-- 	<input type="hidden" name="user_id" value=""/> --%>
<%-- 	<input type="hidden" name="client_id" value="${S_USER.user_id }"/> --%>
<%-- 	<input type="hidden" name="p_title=${pVo.p_title }"/> --%>
<%-- 	<input type="hidden" name="p_code=${pVo.p_code }"/> --%>
<!-- </form> -->
                                    ...
                                    <div class="row">                                           
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align = "center">시작일 : ${pVo.p_sdt }</td>
                                                <td align = "center">종료일 : ${pVo.p_edt }</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <textarea id="summernote3" name="summernote"></textarea>
                                            </td>
                                            </tr>
	                                        </tbody>
	                                    </table> 
	                              	  </div>
	                              	   <button style="margin-left: 425px;" type="button" class="btn btn-primary" id="signup" data-toggle="modal" data-target="#exampleModalLong"><span>서명</span></button>
                                        <button type="button" id="contract" class="btn btn-primary">계약하기</button>
                                    </form>
                                </div>
                            </div>
                        </div>
			...
			<div class="col-12 col-xl-2">
				<div class="card mb-2" style="margin-top: 25px;">
					<div class="card-header d-flex justify-content-between align-items-center">
						<h4 class="card-title" style="width: 210px; text-align: center">사인</h4>
					</div>
					<div class="card-body" style="margin-top: 100px;">
						<div class="media d-block d-sm-flex text-center text-sm-left mb-4">
							<div class="media-body align-self-center redial-line-height-1_5">
								<h6 class="my-2 my-sm-0 redial-line-height-1_5 mb-xl-2">클라이언트 사인하는곳</h6>
							</div>
						</div>
					</div>
				</div>
...
<!-- 			<div class="col-12 col-xl-2" style=" margin-left: 1245px; margin-top: -740px;"> -->
				<div class="card mb-2" style="margin-top: 150px;">
					...
					<div class="card-body" style="margin-top: 100px;">
						<div class="media d-block d-sm-flex text-center text-sm-left mb-4">
							<div class="media-body align-self-center redial-line-height-1_5">
								<h6 class="my-2 my-sm-0 redial-line-height-1_5 mb-xl-2">파트너스 사인하는곳</h6>
							</div>
						</div>
					</div>
				</div>
