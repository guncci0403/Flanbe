								...
								<c:choose>
									...
									<c:otherwise>
										<div class="form-row" style="border-bottom: 1px solid lightgray; border-top: 1px solid lightgray;">
											<span class="form-control col-2" style="border: none; text-align: center; padding-top: 8px; color: #999999; background-color: #fafafa; font-size: 16px;">진행한 프로젝트</span> <input readonly="readonly" type="text" class="form-control col-2" style="border: none; text-align: left; font-size: 16px;" value="    ${cntJoinProj } 개"> <span class="form-control col-2" style="border: none; text-align: center; padding-top: 8px; color: #999999; background-color: #fafafa; font-size: 16px;">누적 프로젝트 금액</span> <input readonly="readonly" type="text" class="form-control col-2" id="sumMoney" style="border: none; text-align: left; font-size: 16px;" value="    <fmt:formatNumber value="${sumMoney }"/> 원">
										</div>
										<br>
										<br>
										<div class="form-row col-12">
											...
											<div class="form-control part col-4" style="border-right: 2px dashed lightgray;">
												<br> <br> <span style="border: none; text-align: center; padding-top: 8px; color: #999999; font-size: 16px;">프로젝트 평균 금액</span> <br> <br> <br> <br> <br> <input readonly="readonly" type="text" id="avgMoney" style="border: none; text-align: center; margin-left: 20%; font-size: 22px; font-weight: bold;" value="<fmt:formatNumber value="${avgMoney }"/> 원">

											</div>
											<div class="form-control part col-4">
												<br> <br> <span style="border: none; text-align: center; padding-top: 8px; color: #999999; font-size: 16px;">프로젝트 평균 기간</span> <br> <br> <br> <br> <br> <input readonly="readonly" type="text" style="border: none; text-align: center; margin-left: 20%; font-size: 22px; font-weight: bold;" value="${avgPeriod } 일">
											...
											<c:forEach items="${projectMap }" var="project">
												<div class="card border h-invoice-list-section">
													<div class="card-header border-bottom p-3 d-flex">
														<span style="margin-right: 10px;">프로젝트 명 : </span> <span style="font-size: 15px;"> ${project.p_title } </span>
													</div>
