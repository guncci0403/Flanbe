            ...
            <div class="col-12 col-lg-3 col-xl-2 mb-4 mt-3 pr-lg-0 flip-menu">
                ...
                <div class="card border h-100 mail-menu-section leftBarAll">
                    ...
                    <ul class="list-unstyled inbox-nav mb-0 mt-2 notes-menu">
                        <li class="nav-item"><a onclick="basicInfo()" class="nav-link active"><i class="icon-envelope pr-2"></i> 기본 정보</a></li>
                        <li class="nav-item"><a onclick="mainProjectBoard( 1 , 'basic')" class="nav-link">
                        <i class="icon-star pr-2"></i>참여한 프로젝트</a></li>
                        <li class="nav-item"><a  onclick="viewUserList()" class="nav-link"><i class="icon-exclamation pr-2"></i>비교</a></li>                               
                        <!-- <li class="nav-item"><a onclick="ProjectEval()" class="nav-link"><i class="icon-exclamation pr-2"></i>프로젝트 평가결과</a></li> -->                               
                    </ul>
                    <div id="leftSide">
