								...
								<div class="form">
									...
									<c:if test="${parentTitle != null }">
										<div class="form-group">
											<label class="labelCont" id="upperWork"><i class="icon-action-redo"></i>상위업무 </label> <label> : ${parentTitle}</label>
										</div>
									</c:if>

									<div class="form-group">
										<label class="labelCont"><i class="icon-people icons"></i>담당자 : </label> <label>${noteVo.user_id}</label> <small class="form-text"></small>
									</div>

									<div class="form-group">
										<label class="labelCont"><i class="icon-docs icons"></i>업무분류 : </label> <label>${noteVo.category}</label> <br>
									</div>

									<div class="form-group">
										<label class="labelCont"><i class="icon-chart icons"></i>상태 : </label> <label>${noteVo.code_name}</label>
									</div>

									<div class="form-group">
										<label class="labelCont"><i class="icon-chart icons"></i>진행률 : </label> <label>${noteVo.progress}%</label>
									</div>


									<div class="form-group">
										<label class="labelCont"><i class="icon-calendar icons"></i>시작일자 : </label> <label>${noteVo.n_sdt}</label> <small class="form-text"></small>
									</div>
									<div class="form-group">
										<label class="labelCont"><i class="icon-calendar icons"></i>마감일자 : </label> <label>${noteVo.n_edt}</label>
									</div>
									<br>
									<div class="form-group">
										<label class="labelCont"><i class="icon-doc icons"></i>업무명</label> <br> <label>${noteVo.n_title }</label>
									</div>
									<div class="form-group">
										<label class="labelCont"><i class="icon-speech icons"></i>업무내용</label><br> <label id="content">${noteVo.n_cont}</label>
									</div>
								</div>
