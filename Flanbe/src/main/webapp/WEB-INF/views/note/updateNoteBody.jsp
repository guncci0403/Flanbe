							...
							<div class="tab-pane fade active show" id="id1">
								<div class="form">
									...
									<div class="form-group">
										...
										</select> <br> <input type="text" style="display: none" value="${noteVo.category}" name="etc" id="etcSelect" placeholder="업무분류를 입력해 주세요"> <small class="form-text"> &nbsp;&nbsp;&nbsp; : 원하는 업무를 선택하세요 직접 입력도 가능합니다.</small>
									</div>
									<div class="form-group">
									...
									<div name="" class="form-group">
										<label class=" "><i class="icon-calendar icons"></i>시작일자</label> <input type="Date" name="n_sdt" value="${noteVo.n_sdt}"> <small class="form-text"></small>
									</div>
									<div class="form-group">
										<label class=""><i class="icon-calendar icons"></i>마감일자</label> <input type="Date" name="n_edt" value="${noteVo.n_edt}"> <small class="form-text"> &nbsp;&nbsp;&nbsp; : 시작일자와 마감일자를 입력해 주세요</small>
									</div>
									<br>
									<div class="form-group">
