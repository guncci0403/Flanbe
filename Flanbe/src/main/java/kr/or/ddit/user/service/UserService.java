...
public interface UserService {
	...
	// 파트너스 리스트 조회
	Map<String, Object> selectPartnerList(PageVo page);
	...
	// 파트너스 필터 검색
	Map<String, Object> filterPartnerList(PageVo page);
	//////////////////////////////////////////////////////

	// 파트너스 보유기술 필터 검색
	Map<String, Object> skilFilterList(SearchVo search);
...
///////////////////////////////////////////////////////////////////////////
	...
	// 진행한 프로젝트 리스트 페이징
	Map<String, Object> joinProjectPaging(PageVo page);
