...
///////////////////////////////////////////////////////////////////////////
	...
	@Override
	public int representYPopol(int po_no) {
		return template.update("profile.representYPopol", po_no);
	}
	
	@Override
	public int representNPopol() {
		return template.update("profile.representNPopol");
	}
