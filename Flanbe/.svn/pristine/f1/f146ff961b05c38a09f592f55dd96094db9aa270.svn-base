...
//       var _top = Math.ceil(( window.screen.width - _height )/2); 
    ...
    window.open("${cp}/contract/viewmeeting?m_no="+arg.event._def.groupId, "PopupWin", "width=500,height=500,left=700,top=280");
//     window.open("${cp}/project/viewproject?p_code=${project.p_code}", "PopupWin", "width=1000,height=600");
    },
...
<!--          <input type="hidden" name="m_no"> -->
            ...
            <div class="container-fluid site-width" style="margin-top: 60px;">
                  <div class="col-12 col-md-12 mt-3" style="margin-left: 50px;">
