							                                        ...
							                                        <c:forEach items="${replyVoList}" var="replyVo">
							                                            ...
							                                            <tr class="eachReplyTr" id="${replyVo.r_no}" data-rnumber="${replyVo.r_no}" data-pno="${replyVo.r_parent}">
							                                                ...
							                                                <td class="deleteAjaxTd" style="width: 180px;">
							                                                	...
							                                                	<button class="btn btn-outline-primary deleteReply" data-delete="${replyVo.r_no }" ><i class="fa fa-trash deleteIcon"></i></button>
							                                                 	<!-- 댓글 수정하는 버튼 -->
							                                                 	<button class="btn btn-outline-primary updateReplyView" data-rno="${replyVo.r_cont }" data-rnono="${replyVo.r_no}"><i class="far fa-edit updateIcon"></i></button>
							                                                  	<!-- 대댓글 작성하는 버튼 -->
							                                                  	<!-- 수정이가 수정함 id data로 변해버림 -->
