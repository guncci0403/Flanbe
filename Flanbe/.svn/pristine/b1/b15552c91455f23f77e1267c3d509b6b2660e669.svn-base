      ...
      $(function(){
         ...
         $("#chkbtn").click(function(){
             ...
             if(todayCompare.getTime() > deadlineCompare.getTime()) {
                 alert("모집 마감일은 현재 요일 이후로 설정 가능합니다.");
                 return false;
             }
             if(deadlineCompare.getTime() > startdayCompare.getTime()) {
                 alert("시작일은 모집마감일 이후로 설정 가능합니다.");
                 return false;
             }
