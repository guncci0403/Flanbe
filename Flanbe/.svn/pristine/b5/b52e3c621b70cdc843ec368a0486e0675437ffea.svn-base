                            ...
                            <div class="card-body p-0">
								<div class="col-md-12 col-lg-12">
                                    <div class="card-body border brd-gray border-top-0 border-right-0 border-left-0">
                                        <h3 class="mb-0"><a class="f-weight-500 text-primary">[${pVo.p_title }] 프로젝트 계약 내용</a></h3>
...
<!--                                             </label> -->
                                            <div class="todo-content">                                                        
                                                ...
                                                <p class="text-muted mb-0 font-weight-bold todo-date">미팅 날짜 : <fmt:formatDate value="${user.mtdt }"></fmt:formatDate></p>
                                            </div>
                                            <div class="ml-auto">
                                            <c:choose>
                                    ...
                                    <strong class="mb-0" lang="ca"> 계약 파트너스 목록 </strong>  <br>  <br>
                                     ...
                                     <c:forEach items="${contractList }" var="conUser">
                                        <li class="todo-item" >
                                            ...
                                            <p class="small-content mb-0 font-15" style="color: green; margin-right: 20px;" data-meetF>계약 승인(관리자)</p>
                                            </c:when> 
                                            <c:when  test="${conUser.s_no eq '04'}">
                                            <p class="small-content mb-0 font-15" style="color: green; margin-right: 20px;" data-meetF>계약 완료</p>
                                              ...
                                              <div>
                                                <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-options-vertical font-15"></i></a>
                                                <div class="dropdown-menu p-0 m-0 dropdown-menu-right">
                                                    <a class="dropdown-item" href="#" data-toggle="modal">계약 내용 보기 </a>
                                                </div>
                                            </div>   
                                        </li>
                                        </c:forEach>
...
<!--                                               <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalLong"><span> 계약 내용</span></button> -->
<!--                                               <button type="button" id="contract" class="btn btn-primary"><span> 계약 하기</span></button> -->
<!--                                     </div> -->
<!--                                 </div>  -->
                             </div>
                        </div>
